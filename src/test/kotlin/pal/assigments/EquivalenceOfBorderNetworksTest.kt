...
import pal.Runner
import pal.assigments.EquivalenceOfBorderNetworks.EquivalenceOfBorderNetworks
import java.io.InputStream

internal class EquivalenceOfBorderNetworksTest: Runner("EquivalenceOfBorderNetworks"){
    ...
    override fun run(input: InputStream) = EquivalenceOfBorderNetworks(input).compute()
}