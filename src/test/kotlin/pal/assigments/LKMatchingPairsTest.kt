...
import pal.Runner
import pal.assigments.LKMatchingPairs.LKMatchingPairs
import pal.assigments.LaserHighways.LaserHighways
import pal.assigments.ReducedNetwork.ReducedNetwork
import java.io.InputStream

internal class LKMatchingPairsTest: Runner("LKMatchingPairs"){
    ...
    override fun run(input: InputStream) = LKMatchingPairs(input).compute()
}