...
import pal.Runner
import pal.assigments.MinibusTrips.MinibusTrips
import pal.assigments.ReducedNetwork.ReducedNetwork
import java.io.InputStream

internal class MinibusTripsTest: Runner("MinibusTrips"){
    ...
    override fun run(input: InputStream) = MinibusTrips(input).compute()
}