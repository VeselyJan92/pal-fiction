...
import pal.assigments.WordsWithGivenPrefix.WordsWithGivenPrefix
import java.io.InputStream

internal class WordsWithGivenPrefixTest: Runner("WordsWithGivenPrefix"){
    ...
    override fun run(input: InputStream) = WordsWithGivenPrefix(input).compute()
}